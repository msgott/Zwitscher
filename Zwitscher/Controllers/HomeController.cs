...
namespace Zwitscher.Controllers
{
    public class HomeController : Controller //Controller Class for mainly handling the Dashboard
    {
        ...
        //Serves the View for the Home Index page
        //Currently not used
        {
        ...
        //Routed to Root
        //Serves the View for the Dashboard page

        {
            #region get Data for Charts and Dashboard
            // Total User
        ...
        //currently not used because Apps development mode is active
        //Serves a custom View for elegant Error handling
        {
        ...
        //HTTP Get UsersSortedByFollowedBy Download endpoint
        //Serves the UsersSortedByFollowedBy csv File as Download
        {
        ...
        //HTTP Get UsersSortedByBlockedBy Download endpoint
        //Serves the UsersSortedByBlockedBy csv File as Download
        {
        ...
        //HTTP Get downloadAdmins Download endpoint
        //Serves the downloadAdmins csv File as Download
        {
        ...
        //HTTP Get downloadMods Download endpoint
        //Serves the downloadMods csv File as Download
        {
            string csvresult = "Username";
        ...
        //HTTP Get downloadAllUsers Download endpoint
        //Serves the downloadAllUsers csv File as Download
        {
